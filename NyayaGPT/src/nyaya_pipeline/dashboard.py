...
Shows side-by-side responses from base Mistral and fine-tuned NyayaGPT.
Routes 50/50 traffic and logs each request to MLflow.
...
st.caption("Base Mistral-7B vs Fine-tuned NyayaGPT on Indian legal questions")
